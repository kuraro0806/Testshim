...
tooldir = "/home/m_inokawa/workspace/for_compile/insertMacro20200109/"
tmpdir = tooldir + "tmp/"
headerfile = tmpdir + "header_inokawa.txt"
startfile = tmpdir + "start_inokawa.txt"
endfile = tmpdir + "end_inokawa.txt"
headertmp = []
starttmp = []
endtmp = []
